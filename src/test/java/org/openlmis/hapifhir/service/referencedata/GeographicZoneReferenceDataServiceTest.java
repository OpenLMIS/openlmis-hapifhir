...
public class GeographicZoneReferenceDataServiceTest
  ...
  private final GeographicZoneReferenceDataService service =
      new GeographicZoneReferenceDataService();

  @Override
  protected BaseReferenceDataService<GeographicZoneDto> getService() {
    return service;
  }

  @Override
  protected GeographicZoneDto generateInstance() {
    return DtoGenerator.of(GeographicZoneDto.class);
  }
