...
pipeline {
    ...
    stages {
        ...
        stage('Push image') {
            ...
            steps {
                sh "docker pull openlmis/hapifhir:${STAGING_VERSION}"
                sh "docker tag openlmis/hapifhir:${STAGING_VERSION} openlmis/hapifhir:${VERSION}"
                sh "docker push openlmis/hapifhir:${VERSION}"
            }
            post {
                success {
                    script {
